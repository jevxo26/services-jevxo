                  ...
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2">
                    <div className="relative">
                      {provider.avatar ? (
                        ...
                        <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#1E4E8C] to-[#818CF8] text-white flex items-center justify-center font-black text-lg border-4 border-white shadow-md uppercase">
