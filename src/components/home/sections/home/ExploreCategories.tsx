                    ...
                    >
                      ...
                      >
                        ...
                        {cat.image ? (
                          ...
                          <IconComponent
                            className="relative w-5 h-5 md:w-7 md:h-7 text-[#1E4E8C] drop-shadow-[0_1px_1px_rgba(0,0,0,0.06)] transition-all duration-500 group-hover:text-white group-hover:drop-shadow-[0_2px_4px_rgba(0,0,0,0.2)]"
                            strokeWidth={1.75}
                          />
                        )}
                      </div>
                      ...
                      {/* Label */}
                      <span
                        className="font-semibold text-[10px] md:text-xs lg:text-[14px] text-center text-slate-700 mt-1 transition-colors duration-200 group-hover:text-[#1E4E8C] line-clamp-2 min-h-[2.2em] md:min-h-[auto] flex items-center justify-center"
                      >
                        {cat.name}
                      </span>
                    </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {/* Label */}
                    <span
                      className="font-bold text-[10px] md:text-xs lg:text-[14px] text-center text-[#1E4E8C] mt-1 transition-colors duration-200 group-hover:text-[#1E4E8C] line-clamp-2 min-h-[2.2em] md:min-h-[auto] flex items-center justify-center"
                    >
                      See More
                    </span>
                  </div>
