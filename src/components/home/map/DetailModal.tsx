      ...
      {expert && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            {/* Header Visual Cover */}
            <div className="p-5 sm:p-6 bg-gradient-to-r from-rose-500 to-[#4F46E5] text-white relative">
              <Button
                variant="ghost"
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5 sm:space-y-6 custom-scrollbar">
              ...
              <div className="space-y-3 pt-1">
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-center gap-2.5 sm:gap-3 text-xs sm:text-sm text-slate-700 font-semibold">
                    <div className="w-6 sm:w-7 h-6 sm:h-7 rounded-lg bg-[#4F46E5]/5 text-[#4F46E5] flex items-center justify-center shrink-0">
            ...
            <div className="p-4 sm:p-6 border-t border-slate-100 flex items-center justify-between bg-slate-50">
              ...
              <div className="flex gap-2 sm:gap-3">
                <Button
                  ...
                  className="px-3 sm:px-6 py-2 sm:py-3 bg-[#4F46E5] hover:bg-[#4338CA] text-white font-extrabold rounded-xl text-[10px] sm:text-xs shadow-sm transition-all active:scale-97 border-none cursor-pointer h-auto"
                >
                  Book Appointment
                </Button>
              </div>
