...
const SectionHeader = ({ title, viewAllHref }: { title: string; viewAllHref?: string }) => (
  <div className="flex items-center justify-between mb-6 pb-3 border-b border-slate-100">
    <div className="relative">
      ...
      <div className="absolute -bottom-[3px] left-0 w-12 h-[3px] bg-[#1E4E8C] rounded-full" />
    </div>
    {viewAllHref && (
      <Link
        href={viewAllHref}
        className="text-xs font-extrabold text-[#1E4E8C] hover:text-[#123C73] transition-colors flex items-center gap-1 uppercase tracking-wider"
      >
  ...
  return (
    <div className="space-y-16 pb-16">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="inline-flex items-center gap-2 bg-[#1E4E8C]/10 border border-[#1E4E8C]/20 text-[#1E4E8C] px-3.5 py-1.5 rounded-full text-xs font-bold mb-4">
          <Sparkles size={13} />
          Explore By Category
        </div>
                    ...
                    <div className="p-5 flex flex-col flex-1 justify-between">
                      <div>
                        ...
                        <div className="flex items-center gap-4 text-[11px] font-semibold text-slate-500">
                          ...
                          <span className="flex items-center gap-1.5">
                            <CalendarCheck size={12} className="text-[#1E4E8C]" />
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-slate-100 mt-4">
                        ...
                        <Link
                          ...
                          className="text-xs font-bold text-[#1E4E8C] hover:text-[#123C73] transition-colors flex items-center gap-1"
                        >
