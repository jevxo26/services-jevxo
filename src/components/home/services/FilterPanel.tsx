          ...
          >
            ...
            <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-[#EEF2FF] flex items-center justify-center text-[#1E4E8C]">
              ...
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={onClearAll}
                  className="text-xs font-bold text-slate-500 hover:text-[#1E4E8C] hover:bg-[#EEF2FF]/50 transition-colors bg-slate-100 px-3 py-2 rounded-xl cursor-pointer"
                >
                  Clear all
                </button>
                <button
                  type="button"
                  onClick={onClose}
                  className="w-9 h-9 flex items-center justify-center rounded-xl bg-slate-100 text-slate-600 hover:text-[#1E4E8C] hover:bg-[#EEF2FF] transition-all cursor-pointer"
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8 scrollbar-thin">
                      ...
                      return (
                        <motion.button
                          ...
                          className={`flex items-center gap-2.5 px-3.5 py-3 rounded-xl border text-xs font-bold transition-all duration-200 text-left cursor-pointer ${
                            isActive
                              ? "border-[#1E4E8C] bg-[#EEF2FF] text-[#1E4E8C] shadow-[0_4px_12px_rgba(255,90,95,0.08)]"
              ...
              <section className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-extrabold text-[#1E4E8C] bg-[#EEF2FF] px-2.5 py-1 rounded-lg">
                    ...
                    return (
                      <motion.label
                        ...
                        className={`flex items-center justify-between gap-3 px-4 py-3 rounded-xl border cursor-pointer transition-all ${
                          isActive
                            ? "border-[#1E4E8C] bg-[#EEF2FF] shadow-[0_4px_12px_rgba(255,90,95,0.05)]"
                    ...
                    return (
                      <motion.button
                        ...
                        className={`flex items-center justify-between gap-3 px-4 py-3 rounded-xl border text-xs font-bold transition-all cursor-pointer ${
                          isActive
                            ? "border-[#1E4E8C] bg-[#EEF2FF] text-[#1E4E8C]"
    ...
    <aside className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm space-y-6 sticky top-24">
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[11px] font-extrabold text-[#1E4E8C] bg-[#EEF2FF] px-2 py-0.5 rounded-lg">
