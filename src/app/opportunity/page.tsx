  ...
  if (!selectedRole) {
    return (
      <div className="flex-1 bg-transparent flex flex-col justify-center py-20 px-4 md:px-6 relative overflow-hidden font-sans">
        ...
        <div className="pointer-events-none absolute -top-32 -right-32 w-96 h-96 bg-[#4F46E5]/5 blur-[120px] rounded-full" />
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="text-center mb-12 space-y-4">
            <div className="inline-flex items-center gap-2 text-[10px] font-extrabold text-[#4F46E5] uppercase tracking-[.12em] bg-[#FFF4EE] px-3.5 py-1.5 rounded-full border border-[#4F46E5]/20">
              <Sparkles className="w-3.5 h-3.5" />Partnership Opportunities
            </div>
            <h1 className="text-xl md:text-3xl lg:text-4xl font-medium text-slate-900 tracking-tight leading-tight">Join <span className="text-[#4F46E5]">Rajseba</span> Platform</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <button key={role} onClick={() => handleSelectRole(role)} className="bg-white border border-slate-100/90 rounded-3xl p-8 hover:border-[#4F46E5]/20 hover:shadow-[0_12px_40px_rgba(79, 70, 229,0.06)] hover:-translate-y-1 transition-all duration-300 text-left group cursor-pointer relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-[#4F46E5]/[0.01] to-transparent pointer-events-none" />
                <div className="w-14 h-14 bg-[#FFF4EE] border border-[#4F46E5]/15 rounded-2xl flex items-center justify-center text-[#4F46E5] mb-6 group-hover:scale-110 transition-transform"><Icon size={26} /></div>
                ...
                <div className="flex items-center text-[#4F46E5] font-extrabold text-xs uppercase tracking-wider">{label} <ArrowRight size={14} className="ml-1.5 group-hover:translate-x-1 transition-transform" /></div>
              </button>
            ))}
          </div>
        </div>
  ...
  return (
    <div className="bg-transparent flex-1 flex flex-col justify-center py-10 md:py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full px-4 md:px-6 relative z-10">
        <button onClick={() => handleBack(selectedRole)} className="mb-8 text-xs font-black uppercase tracking-wider text-slate-400 hover:text-[#4F46E5] flex items-center transition-colors cursor-pointer">
          ...
          <div className="md:col-span-5 flex flex-col justify-between shrink-0 min-h-[420px] md:min-h-[520px] py-4">
            <div>
              <span className="text-xl font-black text-slate-800 flex items-center gap-2 mb-6">
                <span className="w-7 h-7 bg-[#4F46E5] rounded-lg flex items-center justify-center text-xs text-white">R</span>Rajseba
              </span>
              <div>
                <div className="inline-flex items-center gap-2 text-[9px] font-extrabold text-[#4F46E5] uppercase tracking-wider bg-[#4F46E5]/10 border border-[#4F46E5]/20 px-3 py-1 rounded-full mb-4">
            ...
            <div className="space-y-5 my-6">
              <h4 className="text-sm font-medium uppercase tracking-widest text-[#4F46E5] border-b border-slate-100 pb-2.5 mb-2">{selectedRole === "Vendor" ? "Vendor Benefits & Revenue" : "Agent Opportunities & Commissions"}</h4>
              {benefits.map((b: any, i) => (
                <div key={i} className="flex gap-4">
                  <div className="w-10 h-10 rounded-full bg-[#4F46E5]/10 border border-[#4F46E5]/20 flex items-center justify-center text-[#4F46E5] shrink-0 font-black text-sm">
          ...
          <div className="md:col-span-7 flex flex-col justify-center py-4">
            <div className="max-w-md w-full mx-auto space-y-6 p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-xl shadow-slate-100/40 bg-white">
              ...
              <div className="flex gap-2">
                <div className={`h-1.5 flex-1 rounded-full ${step >= 1 ? "bg-[#4F46E5]" : "bg-slate-100"}`} />
                <div className={`h-1.5 flex-1 rounded-full ${step >= 2 ? "bg-[#4F46E5]" : "bg-slate-100"}`} />
              </div>
              ...
              {step === 1 ? (
                <form onSubmit={(e) => handleRegister(e, selectedRole)} className="space-y-4">
                  {[
                    ...
                    <div key={name} className="space-y-1.5">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5"><Icon size={13} className="text-[#4F46E5]" />{label}</label>
                  ...
                  <button type="submit" disabled={isRegistering} className="w-full mt-6 bg-[#4F46E5] hover:bg-[#4338CA] disabled:opacity-60 text-white text-[11px] font-extrabold tracking-wide py-3.5 h-auto rounded-xl border-none transition-all duration-200 shadow-[0_4px_16px_rgba(79, 70, 229,0.3)] hover:-translate-y-0.5 flex items-center justify-center gap-2 cursor-pointer">
                ...
                <form onSubmit={(e) => handleProfileSubmit(e, selectedRole)} className="space-y-4">
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5"><Building size={13} className="text-[#4F46E5]" />Company / Brand Name</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5"><ImageIcon size={13} className="text-[#4F46E5]" />Profile / Logo Picture</label>
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-slate-200 hover:border-[#4F46E5]/40 rounded-xl bg-slate-50/50 hover:bg-white transition-all cursor-pointer relative group">
                      <div className="space-y-1 text-center">
                        <ImageIcon className="mx-auto h-8 w-8 text-slate-400 group-hover:text-[#4F46E5] transition-colors" />
                        <div className="flex text-xs text-slate-600 justify-center"><span className="relative font-bold text-[#4F46E5]">{pictureFile ? pictureFile.name : "Upload photo"}</span></div>
                  ...
                  {selectedRole === "Agent" && (
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5">
                        <ImageIcon size={13} className="text-[#4F46E5]" /> Your Shop Images (Max 2)
                      </label>
                      <div className="grid grid-cols-2 gap-3">
                        <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#4F46E5]/40 rounded-xl p-3 bg-slate-50/50 hover:bg-white transition-all flex flex-col items-center justify-center text-center cursor-pointer min-h-[90px]">
                          <ImageIcon className="h-5 w-5 text-slate-400 group-hover:text-[#4F46E5] mb-1" />
                          <span className="text-[10px] font-bold text-[#4F46E5] truncate max-w-full px-1">{shopImage1File ? shopImage1File.name : "Shop Image 1"}</span>
                        ...
                        <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#4F46E5]/40 rounded-xl p-3 bg-slate-50/50 hover:bg-white transition-all flex flex-col items-center justify-center text-center cursor-pointer min-h-[90px]">
                          <ImageIcon className="h-5 w-5 text-slate-400 group-hover:text-[#4F46E5] mb-1" />
                          <span className="text-[10px] font-bold text-[#4F46E5] truncate max-w-full px-1">{shopImage2File ? shopImage2File.name : "Shop Image 2"}</span>
                  ...
                  {selectedRole === "Agent" && (
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5">
                          <User size={13} className="text-[#4F46E5]" /> NID Number
                        </label>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5">
                          <ImageIcon size={13} className="text-[#4F46E5]" /> NID Page Images (Front & Back)
                        </label>
                        <div className="grid grid-cols-2 gap-3">
                          <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#4F46E5]/40 rounded-xl p-3 bg-slate-50/50 hover:bg-white transition-all flex flex-col items-center justify-center text-center cursor-pointer min-h-[90px]">
                            <ImageIcon className="h-5 w-5 text-slate-400 group-hover:text-[#4F46E5] mb-1" />
                            <span className="text-[10px] font-bold text-[#4F46E5] truncate max-w-full px-1">{nidFrontFile ? nidFrontFile.name : "NID Front Page"}</span>
                          ...
                          <div className="relative group border-2 border-dashed border-slate-200 hover:border-[#4F46E5]/40 rounded-xl p-3 bg-slate-50/50 hover:bg-white transition-all flex flex-col items-center justify-center text-center cursor-pointer min-h-[90px]">
                            <ImageIcon className="h-5 w-5 text-slate-400 group-hover:text-[#4F46E5] mb-1" />
                            <span className="text-[10px] font-bold text-[#4F46E5] truncate max-w-full px-1">{nidBackFile ? nidBackFile.name : "NID Back Page"}</span>
                  ...
                  {selectedRole === "Vendor" && (
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5"><DollarSign size={13} className="text-[#4F46E5]" />Min Starting Price</label>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5"><Globe size={13} className="text-[#4F46E5]" />Google Map Link</label>
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[.1em] flex items-center gap-1.5"><MapPin size={13} className="text-[#4F46E5]" />Detailed Street Address</label>
                  ...
                  <button type="submit" disabled={isCreatingProfile || isUploading} className="w-full mt-6 bg-[#4F46E5] hover:bg-[#4338CA] disabled:opacity-60 text-white text-[11px] font-extrabold tracking-wide py-3.5 h-auto rounded-xl border-none transition-all duration-200 shadow-[0_4px_16px_rgba(79, 70, 229,0.3)] hover:-translate-y-0.5 flex items-center justify-center gap-2 cursor-pointer">
...
export default function OpportunityPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-white"><Loader2 className="w-10 h-10 animate-spin text-[#4F46E5]" /></div>}>
