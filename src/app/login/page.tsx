            ...
            <div className="w-full max-w-[440px] bg-white rounded-3xl sm:rounded-none border border-slate-200 sm:border-0 shadow-xl sm:shadow-none px-6 py-8 sm:px-2 sm:py-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-[88px] pr-5 py-4 rounded-2xl bg-slate-50 border-2 border-slate-100 focus:bg-white focus:border-[#FF6014] focus:ring-4 focus:ring-[#FF6014]/10 focus:outline-none transition-all text-xs font-semibold text-slate-800 placeholder-slate-400"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/help" className="text-xs text-[#FF6014] hover:underline font-bold">
                    Need help?
                  </Link>
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-[#FF6014] hover:bg-[#E0530A] disabled:opacity-60 text-white text-[11px] font-extrabold tracking-wide py-4 rounded-2xl shadow-xl shadow-[#FF6014]/25 hover:shadow-[#FF6014]/35 transition-all flex items-center justify-center gap-2 focus:outline-none active:scale-[0.99] mt-1 border-none cursor-pointer"
                >
                  {isLoading ? (
              ...
              <p className="text-center text-xs text-slate-400 font-bold mt-8">
                ...
                <Link href="/signup" className="text-[#FF6014] hover:underline font-extrabold">
                  Create one free →
                </Link>
              </p>
            ...
            <div className="w-full max-w-[400px] mx-auto">
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-6">
                  ...
                  {otp.map((digit, idx) => (
                    <input
                      ...
                      className={`w-14 h-16 rounded-2xl border-2 text-center text-2xl font-black focus:outline-none transition-all shadow-sm ${digit
                        ...
                        : "border-slate-100 bg-slate-50 text-slate-800 focus:border-[#FF6014] focus:bg-white focus:ring-4 focus:ring-[#FF6014]/10"
                        }`}
                      required
                    />
                  ))}
                ...
                <div className="text-center">
                  {timeLeft > 0 ? (
                    <div className="inline-flex items-center gap-2 text-slate-500 text-xs font-semibold">
                      ...
                      Resend code in{" "}
                      <span className="text-[#FF6014] font-black tabular-nums">
                    ...
                    <button
                      ...
                      className="text-[#FF6014] hover:underline font-black text-xs flex items-center gap-1 mx-auto border-none bg-transparent cursor-pointer"
                    >
                ...
                <button
                  ...
                  className="w-full bg-[#FF6014] hover:bg-[#E0530A] disabled:opacity-50 text-white text-[11px] font-extrabold tracking-wide py-4 rounded-2xl shadow-xl shadow-[#FF6014]/25 active:scale-[0.99] transition-all flex items-center justify-center gap-2 focus:outline-none border-none cursor-pointer"
                >
                  {isVerifying ? (
                    <Loader2 size={18} className="animate-spin" />
                  ) : (
              ...
              <button
                ...
                className="mt-6 w-full text-xs text-slate-500 hover:text-slate-800 font-semibold text-center hover:underline transition-colors border-none bg-transparent cursor-pointer"
              >
                ← Change phone number
              </button>
