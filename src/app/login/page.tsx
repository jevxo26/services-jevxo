      ...
      <div className="flex flex-col justify-between p-6 md:p-12 lg:p-16 max-w-lg mx-auto w-full h-full min-h-[500px]">
        ...
        >
          ...
          <motion.form onSubmit={handleSubmit} variants={itemVariants} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 hover:bg-transparent transition-colors p-2 h-auto"
                >
            ...
            <Button
              type="submit"
              className="w-full bg-[#FF5A5F] hover:bg-[#FF4449] text-white font-bold py-3.5 h-auto rounded-xl transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md active:scale-[0.985] text-base cursor-pointer"
            >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="flex items-center justify-center gap-2 py-3 h-auto rounded-xl border border-slate-200/80 bg-white hover:bg-slate-50 hover:text-slate-700 transition-colors font-bold text-sm text-slate-700 cursor-pointer">
