...
export const PILLARS = [
  ...
  { title: "Premium Damage Guarantee", description: "All service appointments are backed by Jevxo Services's damage protection guarantee for absolute peace of mind.", icon: Heart, bg: "bg-[#EEF2FF] text-[#1E4E8C]" },
