  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="bg-white border-y border-slate-100 py-10 md:py-14 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <Reveal variants={stagger} className="text-center max-w-2xl mx-auto mb-10 lg:mb-14">
            <h2 className="text-lg md:text-xl font-bold text-foreground mb-3 tracking-wide">
      ...
      <section className="bg-white py-10 md:py-14 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <Reveal variants={stagger} className="text-center max-w-2xl mx-auto mb-10 lg:mb-14">
            <span className="inline-block text-xs font-black text-[#FF7C71] uppercase tracking-widest bg-[#FFF8F7] px-3.5 py-1.5 rounded-full border border-rose-100/50">
              The Minds
            </span>
            <h2 className="text-lg md:text-xl font-bold text-foreground mt-3 mb-3 tracking-wide">
