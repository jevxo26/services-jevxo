    ...
    },
    {
      ...
      render: (item: Withdraw) => (
        <button
          ...
          className="flex items-center gap-1 bg-[#EEF2FF] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] px-2.5 py-1 rounded-lg text-xs font-bold transition-all shadow-xs cursor-pointer"
        ...
        <div className="flex gap-2">
          {state.withdraws && state.withdraws.length > 0 && (
            <button
              ...
              className="flex items-center gap-2 bg-[#EEF2FF] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] font-bold px-4 py-2.5 rounded-xl text-sm transition-all shadow-xs cursor-pointer"
            >
              <FileText size={16} />
