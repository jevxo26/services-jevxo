    ...
    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-6">
      <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
        ...
        <div className="relative">
          ...
          />
          <button className="absolute bottom-0 right-0 p-1.5 bg-[#4F46E5] hover:bg-[#4338CA] text-white rounded-full border-2 border-white shadow-md transition-transform active:scale-90">
        ...
        <div>
          ...
          <span className="inline-flex items-center gap-1 bg-[#EEF2FF] text-[#4F46E5] text-xs font-bold px-3 py-1 rounded-full mt-2 border border-[#E0E7FF]">
            {lang === "bn" ? "★ প্রিমিয়াম মেম্বার" : "★ Premium Member"}
          </span>
        </div>
      </div>

      <button className="bg-[#4F46E5] hover:bg-[#4338CA] text-white font-bold px-6 py-2.5 rounded-full text-xs shadow-md shadow-[#4F46E5]/10 transition-all active:scale-[0.98]">
