...
export default function SettingsPage() {
  ...
  const Switch = ({ checked, onChange }: { checked: boolean; onChange: () => void }) => (
    <button
      type="button"
      onClick={onChange}
      className={`w-11 h-6 rounded-full transition-colors relative focus:outline-none shrink-0 ${checked ? "bg-[#FF6014]" : "bg-slate-200"
        }`}
    >
      <span
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <button className="text-slate-400 hover:text-[#FF6014] text-xs font-bold transition-colors">Disconnect</button>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <button className="text-[#FF6014] hover:text-[#E0530A] text-xs font-bold transition-colors">Connect</button>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 border border-[#FFF0EB] bg-[#FFF8F4]/20 rounded-2xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-[#FF6014] font-bold block mt-0.5">Primary Payment Option</span>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-slate-100 rounded-2xl">
                    ...
                    <button className="text-xs font-semibold text-slate-400 hover:text-[#FF6014] transition-colors">Delete</button>
                  </div>
                </div>
              </div>
            )}
