    ...
    <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300 pb-16">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 gap-6">
                ...
                {showCustDrop && custSuggestions.length > 0 && (
                  <div className="absolute left-0 right-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-lg z-50 overflow-hidden divide-y divide-slate-50">
                    {custSuggestions.map(c => (
                      <div
                        key={c.id}
                        className="px-4 py-2.5 text-xs text-slate-700 hover:bg-[#EEF2FF] hover:text-[#1E4E8C] cursor-pointer transition-colors"
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm space-y-6 overflow-visible">
            <div className="flex justify-between items-center border-b border-slate-50 pb-4">
              ...
              <button
                type="button"
                className="flex items-center gap-1.5 bg-[#EEF2FF] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] font-bold px-3 py-1.5 rounded-xl text-xs transition-all shadow-xs cursor-pointer active:scale-95"
                onClick={addItem}
              >
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
          ...
          <button
            type="submit"
            className="flex items-center gap-1.5 bg-[#1E4E8C] hover:bg-[#123C73] text-white font-bold px-5 py-2.5 rounded-xl text-sm transition-all shadow-sm shadow-orange-500/10 cursor-pointer active:scale-95"
            disabled={submitting}
          >
