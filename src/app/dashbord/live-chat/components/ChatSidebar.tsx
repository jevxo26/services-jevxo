    ...
    >
      <div className="p-4 border-b border-slate-100 bg-white space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] font-extrabold text-[#1E4E8C] bg-[#EEF2FF] border border-[#1E4E8C]/20 px-2 py-0.5 rounded-full">
              ...
              return (
                <motion.button
                  ...
                  className={`w-full text-left p-3 flex items-center gap-3 transition-all cursor-pointer rounded-2xl ${
                    isActive
                      ? "bg-[#EEF2FF] border-l-4 border-l-[#1E4E8C] border border-[#1E4E8C]/15 shadow-sm shadow-[#1E4E8C]/5"
