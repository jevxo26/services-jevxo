  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 hover:border-[#1E4E8C]/15 hover:shadow-lg hover:shadow-[#1E4E8C]/5 transition-all duration-300 p-6">
      ...
      <div className="grid grid-cols-3 gap-3 md:gap-4">
        <div className="text-center p-4 bg-slate-50/50 hover:bg-[#EEF2FF]/30 hover:border-[#1E4E8C]/10 rounded-2xl border border-slate-100 transition-all duration-200 group/item">
