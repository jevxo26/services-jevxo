        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
            <div className="flex gap-4">
              <div className="w-14 h-14 bg-[#EEF2FF] border border-[#E0E7FF] rounded-2xl flex items-center justify-center text-[#1E4E8C] shrink-0">
        ...
        {booking.status === 'completed' && (
          <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm mt-6">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-2xl bg-[#EEF2FF] text-[#1E4E8C] flex items-center justify-center">
