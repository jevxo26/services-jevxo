          ...
          <div className="flex flex-col gap-2">
            {booking.vendor && (
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-full bg-[#E0E7FF] flex items-center justify-center text-[#123C73] font-bold text-xs border border-[#1E4E8C]/30">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-slate-50">
        <div className="flex items-center gap-2 flex-wrap">
          {booking.vendor && (
            <button
              ...
              className="flex items-center gap-1.5 text-[#1E4E8C] bg-[#EEF2FF] hover:bg-[#E0E7FF] px-3 py-1.5 rounded-lg text-xs font-bold transition-colors focus:outline-none cursor-pointer"
            >
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto flex-wrap">
          <button
            ...
            className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 bg-[#EEF2FF] border border-[#1E4E8C]/20 hover:bg-[#1E4E8C] hover:text-white text-[#1E4E8C] text-xs font-bold py-2.5 px-4 rounded-2xl transition-all cursor-pointer shadow-xs active:scale-[0.98]"
          >
            <Download size={14} />
