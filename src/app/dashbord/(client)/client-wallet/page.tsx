          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <div className="space-y-3">
              <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between gap-4">
                ...
                <span className="text-[9px] font-bold text-[#1E4E8C] bg-[#EEF2FF] px-2 py-0.5 rounded-lg">
              ...
              <div className="bg-white p-4 rounded-3xl border border-slate-100 shadow-sm flex items-center justify-between gap-4">
                ...
                <button className="p-2 bg-slate-50 hover:bg-[#EEF2FF] text-slate-400 hover:text-[#1E4E8C] rounded-xl transition-colors focus:outline-none cursor-pointer">
                  <Trash2 size={14} />
                </button>
              </div>
            </div>
