  ...
  return (
    <div className="w-full space-y-8 animate-in fade-in duration-200">
      ...
      <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 p-8 sm:p-10 shadow-xl border border-slate-800/80">
        <div className="absolute -right-16 -top-16 w-64 h-64 bg-[#1E4E8C]/10 rounded-full blur-3xl" />
        <div className="absolute -left-10 -bottom-10 w-48 h-48 bg-blue-500/10 rounded-full blur-2xl" />
        
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-[10px] font-black tracking-widest text-[#1E4E8C] uppercase">
        ...
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            ...
            <div className="bg-gradient-to-br from-[#EEF2FF] to-white border border-[#E0E7FF] p-6 rounded-3xl shadow-xs space-y-4 hover:shadow-md transition-all group">
              <div className="p-3 bg-white rounded-2xl text-[#1E4E8C] border border-[#E0E7FF] w-fit shadow-xs group-hover:scale-110 transition-transform">
                        ...
                        return (
                          ...
                          >
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 border shadow-xs ${
                              isClient ? "bg-slate-100 text-slate-500 border-slate-200" : "bg-[#EEF2FF] text-[#1E4E8C] border-[#E0E7FF]"
                            }`}>
          ...
          <div className="bg-white rounded-[32px] border border-slate-100 shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 border-b border-slate-150 flex justify-between items-center">
              <div className="flex items-center gap-3">
                <div className="p-2.5 bg-[#EEF2FF] text-[#1E4E8C] rounded-xl border border-[#E0E7FF]">
                  <LifeBuoy size={20} />
                </div>
                <div>
