    ...
    <div className="w-full animate-in fade-in duration-200">
      <div className="w-full space-y-8 relative z-10">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 sm:gap-4 self-stretch md:self-auto">
              <div className="flex-1 md:flex-none bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-3 md:p-4 min-w-[105px] text-center hover:bg-white/15 transition-all">
                {loadingBookings ? (
                  <Loader2 size={18} className="animate-spin text-[#1E4E8C] mx-auto" />
                ) : (
                  <span className="text-2xl md:text-3xl font-black text-[#1E4E8C] block leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            href="/services"
            className="relative overflow-hidden bg-[#1E4E8C] text-white p-6 rounded-[28px] shadow-lg shadow-[#1E4E8C]/10 flex items-center justify-between group hover:opacity-95 transition-all"
          >
          ...
          <div className="bg-white p-6 rounded-[28px] border border-slate-100 shadow-sm flex items-center justify-between hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-[#EEF2FF] rounded-2xl text-[#1E4E8C]">
                <Share2 size={22} />
              </div>
              <div>
            ...
            <button className="p-2.5 bg-[#1E4E8C] text-white rounded-full hover:bg-[#123C73] transition-colors shadow-sm focus:outline-none cursor-pointer">
        ...
        {activeBookings.length > 0 && (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <Link href="/dashbord/bookings" className="text-xs font-bold text-[#1E4E8C] hover:underline">
              ...
              {activeBookings.slice(0, 2).map((booking: any) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="font-extrabold text-[#1E4E8C] text-base">
                    ...
                    <span
                      className={`text-[10px] font-extrabold px-3 py-1 rounded-full uppercase tracking-wider ${
                        booking.status === "on_the_way" ? "text-[#123C73] bg-[#EEF2FF]" : "text-amber-600 bg-amber-50"
                      }`}
                    >
                  ...
                  <div className="flex items-center justify-between bg-slate-50/50 p-3 rounded-2xl border border-slate-100/40">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#E0E7FF] flex items-center justify-center text-[#123C73] font-bold text-sm">
                    ...
                    <button className="p-2 bg-white text-[#1E4E8C] rounded-xl hover:bg-[#EEF2FF] border border-slate-100 shadow-sm transition-colors cursor-pointer">
