    ...
    <div className="bg-white rounded-3xl border border-slate-100 overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col group relative">
      ...
      <div className="relative aspect-[4/3] w-full bg-slate-50 overflow-hidden">
        ...
        <button
          ...
          className="absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center bg-[#1E4E8C] text-white shadow-md hover:scale-110 transition-all cursor-pointer"
      ...
      <div className="p-5 flex-1 flex flex-col justify-between gap-4">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-slate-50 gap-2">
          ...
          <Link
            ...
            className="flex-1 text-center bg-[#1E4E8C] hover:bg-[#123C73] text-white text-xs font-bold px-3 py-2 rounded-xl transition-all shadow-sm"
          >
