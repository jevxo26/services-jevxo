  ...
  return (
    ...
    >
      <div className="my-auto space-y-4">
        <div className="w-12 h-12 bg-[#EEF2FF] rounded-full flex items-center justify-center text-[#1E4E8C] mx-auto border border-[#E0E7FF] group-hover:scale-110 transition-transform">
          <Plus size={20} />
        </div>
      ...
      <div className="mt-6 w-full bg-white group-hover:bg-slate-50 border border-slate-100 text-[#1E4E8C] text-xs font-bold py-2.5 rounded-2xl transition-colors text-center flex items-center justify-center gap-1">
