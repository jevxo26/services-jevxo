...
const PROVIDERS_DATA: ServiceProvider[] = [
  // AC Repair
  {
    ...
    description:
      "Expert AC servicing, master installation, and high-precision gas charging. Specialized in both residential and industrial HVAC systems.",
    isVerified: true,
    isAvailable: true,
  ...
  },
  {
    ...
    description:
      "Affordable AC repair, filtering system cleaning, and fast emergency repair services in Dhaka area.",
    isVerified: true,
    isAvailable: true,
  ...
  // Plumbing
  {
    ...
    image:
      "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=600&auto=format&fit=crop",
    description:
      "Expert plumbing fixes, tap leaks repair, bathroom pipe fitting, and high pressure water line cleaning.",
    isVerified: true,
    isAvailable: true,
    location: "Mirpur, Dhaka",
    jobsCompleted: 310,
  },
  {
    ...
    description:
      "Quick plumbing repairs, blockages clearing, basin installation, and water pump repair services.",
    isVerified: false,
    isAvailable: true,
  ...
  // Cleaning
  {
    ...
    image:
      "https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=600&auto=format&fit=crop",
    description:
      "Professional deep cleaning using non-toxic materials. We restore the luxury of your home with meticulous attention to detail.",
    isVerified: true,
    isAvailable: true,
    location: "Banani, Dhaka",
    jobsCompleted: 280,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=600&auto=format&fit=crop",
    description:
      "Deep cleaning & sanitization experts for residential flats and office spaces. Multi-step cleaning guarantee with eco-friendly tools.",
    isVerified: true,
    isAvailable: true,
    location: "Banani, Dhaka",
    jobsCompleted: 340,
  ...
  // Electrical
  {
    ...
    description:
      "Reliable electrical maintenance and safety audits. From smart home wiring to emergency repair, we handle everything with precision.",
    isVerified: true,
    isAvailable: true,
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1621905252507-b354bc25edac?q=80&w=600&auto=format&fit=crop",
    description:
      "Full wiring & device installation. From ceiling fans to complex breaker boxes, our certified technicians ensure a safe and professional setup.",
    isVerified: true,
    isAvailable: false,
  ...
  // Shifting
  {
    ...
    description:
      "Professional house shifting and furniture moving. Fully secure transport with expert packers and loaders.",
    isVerified: true,
    isAvailable: true,
  ...
  // CCTV
  {
    ...
    description:
      "Home CCTV camera setup, IP camera configuration, DVR diagnostics, and mobile remote viewing setup.",
    isVerified: true,
    isAvailable: true,
  ...
  // Painting
  {
    ...
    image:
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=600&auto=format&fit=crop",
    description:
      "Interior and exterior wall painting, wall putty work, and luxury texture finishing. Dust-free service guaranteed.",
    isVerified: true,
    isAvailable: true,
    location: "Gulshan, Dhaka",
    jobsCompleted: 210,
  ...
  // Home Salon
  {
    ...
    description:
      "Premium ladies facial, haircut, pedicure, manicure, and bridal makeovers directly at your home.",
    isVerified: true,
    isAvailable: true,
    location: "Banani, Dhaka",
    jobsCompleted: 290,
...
export default function CategoryDetailPage({
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 my-12 md:my-16 lg:my-20">
        ...
        <div className="mb-10 text-center md:text-left">
          <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-3 tracking-wide">
            {filteredProviders.length} results found for{" "}
            <span className="text-[#FF5A5F]">{categoryName}</span>
          </h1>
              ...
              <div className="flex flex-wrap gap-2">
                {ALL_CATEGORIES.map((other) => {
                  ...
                  return (
                    ...
                    >
                      <span
                        className={`px-3 py-1.5 rounded-full text-[10px] font-extrabold tracking-wide border inline-block transition-all cursor-pointer ${
                          isActive
            ...
            {filteredProviders.length === 0 ? (
              <div className="bg-white border border-slate-100 rounded-[32px] p-12 text-center shadow-xs">
                ...
                <h3 className="text-lg font-bold text-slate-800">
                  No experts fit this criteria
                </h3>
                <p className="text-sm text-slate-500 mt-2 max-w-sm mx-auto">
                  Try adjusting the BDT price slider, relaxing ratings, or
                  ...
                  >
                    <div>
                      ...
                      <div className="h-48 md:h-52 bg-slate-100 relative overflow-hidden">
                        ...
                        >
                          <Heart
                            className={`w-4 h-4 transition-colors ${wishlist[provider.id] ? "fill-[#FF5A5F] text-[#FF5A5F]" : "text-slate-500"}`}
                          />
                        </Button>
                      </div>
        ...
        <div className="mt-16 bg-[#FFF0F1] border border-rose-100 rounded-3xl p-8 md:p-10 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="space-y-2 relative z-10 text-center md:text-left">
            ...
            <p className="text-slate-500 text-sm max-w-xl">
              If you require a custom contract, commercial volume pricing, or
              dedicated account manager, contact our concierge desk.
            </p>
          </div>
          <a
