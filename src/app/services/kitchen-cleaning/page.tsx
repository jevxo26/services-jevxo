        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-[2] flex flex-col">
            ...
            <div className="relative w-full h-[400px] lg:h-[450px] rounded-[2.5rem] overflow-hidden mb-12 shadow-[0_10px_40px_rgba(0,0,0,0.1)]">
              <Image src="/images/service/kitchen clean.jpg" alt="Kitchen Cleaning" fill priority className="object-cover object-center" />
            ...
            <div>
              ...
              <p className="text-[#6b7280] text-[1.05rem] leading-relaxed mb-8 max-w-[850px]">
                Revitalize your kitchen with our specialized deep cleaning service. We tackle stubborn grease, sanitize all surfaces, and restore the shine to your cooking space using safe, industrial-grade, eco-friendly products that leave no harmful residue behind.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-[2rem] p-8 border border-[#f3f4f6] shadow-[0_4px_24px_rgba(0,0,0,0.02)] flex flex-col hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-shadow">
                  ...
                  <h3 className="text-[1.2rem] font-bold text-[#1a1a1a] mb-3">Grease Removal</h3>
                  <p className="text-[#6b7280] leading-relaxed text-[0.95rem]">
                    Intensive removal of oil, soot, and grime from stovetops, walls, and exhaust fans.
                  </p>
                </div>

                {/* Cabinet Cleaning Card */}
                <div className="bg-white rounded-[2rem] p-8 border border-[#f3f4f6] shadow-[0_4px_24px_rgba(0,0,0,0.02)] flex flex-col hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-shadow">
                  <div className="w-12 h-12 bg-[#fff0ef] rounded-2xl flex items-center justify-center text-[#ff5a5f] mb-6">
                    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <h3 className="text-[1.2rem] font-bold text-[#1a1a1a] mb-3">Cabinet Cleaning</h3>
                  <p className="text-[#6b7280] leading-relaxed text-[0.95rem]">
                    Deep cleaning inside and out of all cabinetry and pantry spaces.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 bg-white rounded-[2rem] p-8 md:p-10 shadow-[0_4px_24px_rgba(0,0,0,0.02)] border border-[#f3f4f6]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-12">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="text-[1.1rem] font-bold text-[#1a1a1a] mb-1.5">Appliance Exteriors</h3>
                    <p className="text-[#6b7280] text-[0.95rem] leading-relaxed">
                      Wiping and degreasing of fridges, ovens, microwaves, and dishwashers.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="text-[1.1rem] font-bold text-[#1a1a1a] mb-1.5">Sink & Countertops</h3>
                    <p className="text-[#6b7280] text-[0.95rem] leading-relaxed">
                      Detailed descaling and sanitizing of all work surfaces and sink basins.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[#6b7280] text-[0.95rem] leading-relaxed">
                      Thorough mopping and scrubbing of kitchen floors and baseboards.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="text-[1.1rem] font-bold text-[#1a1a1a] mb-1.5">Wall & Tile Wash</h3>
                    <p className="text-[#6b7280] text-[0.95rem] leading-relaxed">
                      Removing food splatters and oil residues from wall tiles and backsplashes.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-16">
              ...
              <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-4">
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <p className="text-[#6b7280] text-[0.9rem] leading-relaxed pr-4">
                    Our certified cleaners arrive equipped with industrial-grade, eco-friendly supplies.
                  </p>
                </div>
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <h3 className="text-[1.1rem] font-bold text-[#1a1a1a] mb-2">Sparkling Kitchen</h3>
                  <p className="text-[#6b7280] text-[0.9rem] leading-relaxed pr-4">
                    Enjoy a completely grease-free, sanitized, and hygienic cooking environment.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-16 mb-8">
              <div className="flex justify-between items-end mb-8">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[#6b7280] text-[0.85rem]">(104 reviews)</span>
                </div>
              </div>
              ...
              <div className="bg-white rounded-[2rem] p-8 border border-[#f3f4f6] shadow-[0_4px_24px_rgba(0,0,0,0.02)]">
                ...
                <p className="text-[#6b7280] italic leading-relaxed text-[0.95rem]">
                  "The team made my 10-year-old kitchen look brand new. The grease is completely gone, and the cabinets are sparkling. Highly recommend Rajseba!"
                </p>
              </div>
            </div>
              ...
              <div className="bg-white rounded-[2.5rem] p-8 border border-[#f3f4f6] shadow-[0_8px_30px_rgba(0,0,0,0.06)]">
                ...
                <div className="border-t border-[#f3f4f6] pt-6 pb-6 mb-6">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <span className="text-[#1a1a1a] font-bold text-[0.95rem]">$30.00</span>
                  </div>
                ...
                <div className="border-t border-[#f3f4f6] pt-6 mb-8 flex justify-between items-center">
                  ...
                  <span className="text-[#ff5a5f] font-bold text-[1.4rem]">$35.00</span>
                </div>

                {/* Book Now Button */}
                <button 
                  onClick={() => alert(`Booking Kitchen Cleaning for ${selectedDate} between ${arrivalWindow}`)}
