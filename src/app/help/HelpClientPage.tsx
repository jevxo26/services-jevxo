    ...
    <div className="bg-transparent overflow-hidden relative flex-1 flex flex-col">
      ...
      <section ref={heroRef} className="relative pt-8 pb-4 md:pt-12 md:pb-6 z-10">
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
          <div className="inline-flex items-center gap-2 text-[10px] font-extrabold text-[#1E4E8C] uppercase tracking-[.12em] bg-[#FFF4EE] px-3 py-1 rounded-full border border-[#1E4E8C]/20 mb-3">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          {hasResults ? (
            ...
            <div className="bg-white/50 backdrop-blur-sm border border-dashed border-slate-200 rounded-2xl p-8 text-center max-w-xl mx-auto">
              <div className="w-10 h-10 rounded-full bg-[#EEF2FF] flex items-center justify-center mx-auto mb-2 text-[#1E4E8C]">
      ...
      <section className="py-8 md:py-10 border-t border-slate-100 bg-[#FFFDFB]/40 relative z-10">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="text-center mb-5">
            <span className="inline-flex items-center gap-1.5 text-[10px] font-extrabold text-[#1E4E8C] uppercase tracking-[.12em] bg-[#FFF4EE] px-3 py-1 rounded-full border border-[#1E4E8C]/20 mb-2">
          ...
          <div className="grid sm:grid-cols-3 gap-3">
            ...
            <div className="bg-white border border-slate-100 hover:border-[#1E4E8C]/20 rounded-2xl p-4 shadow-[0_4px_20px_rgba(0,0,0,0.015)] flex flex-col items-center text-center transition-all duration-300 group">
              <div className="w-9 h-9 rounded-xl bg-[#FFF4EE] border border-[#1E4E8C]/15 flex items-center justify-center text-[#1E4E8C] mb-2.5 group-hover:scale-105 transition-transform">
