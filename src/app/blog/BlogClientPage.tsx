  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-3 duration-300 space-y-6 sm:space-y-8">
      ...
      <div className="space-y-3 max-w-3xl">
        ...
        {blog.overview && (
          <p className="text-sm font-semibold text-slate-600 leading-relaxed border-l-4 border-[#1E4E8C]/50 pl-4 py-2 bg-[#EEF2FF] rounded-r-2xl">
            {blog.overview}
          </p>
        )}
      </div>
    ...
    >
      ...
      <div className="p-4 sm:p-5 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-slate-50 mt-auto">
          <span className="text-[9px] sm:text-[10px] font-extrabold text-[#1E4E8C] uppercase tracking-wider bg-[#FFF4EE] px-2.5 py-1 rounded-full">
            Read Article
          </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-[#FFF4EE] text-[#1E4E8C] rounded-xl shrink-0">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 md:mt-10 relative z-10 w-full">
        ...
        {selectedBlog ? (
          ...
          <div className="text-center py-24 sm:py-32 bg-white/70 backdrop-blur-md border border-dashed border-slate-200 rounded-2xl sm:rounded-3xl space-y-3">
            <div className="w-14 h-14 bg-[#FFF4EE] text-[#1E4E8C] rounded-2xl flex items-center justify-center mx-auto">
              <BookOpen size={24} />
            </div>
