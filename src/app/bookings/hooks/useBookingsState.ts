...
export const STATUS_CONFIG: Record<BookingStatus, { label: string; pillBg: string; pillText: string; borderColor: string; iconBg: string; iconText: string; glowColor: string }> = {
  confirmed: { label: "Confirmed", pillBg: "bg-[#EEF2FF] border-[#4F46E5]/20", pillText: "text-[#4F46E5]", borderColor: "border-l-[#4F46E5]", iconBg: "bg-[#EEF2FF]", iconText: "text-[#4F46E5]", glowColor: "shadow-[0_0_15px_rgba(79, 70, 229,0.08)]" },
...
export function useBookingsState() {
  ...
  const getStats = () => {
    ...
    return [
      { label: "Total Bookings", value: bookings.length.toString(), sub: "All time records", icon: Briefcase, stripeColor: "bg-[#4F46E5]", iconContainerColor: "bg-[#EEF2FF] border-[#4F46E5]/15", iconColor: "text-[#4F46E5]", gradient: "from-white via-white to-orange-50/15", borderColor: "hover:border-[#4F46E5]/25", shadow: "hover:shadow-[0_20px_40px_rgba(79, 70, 229,0.05)]" },
